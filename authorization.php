        ...
        <main class="main">
            <div class="main__container">
                <div class="main_Authorization">
                    <form action="includes/authorizationFunc.php" class="registerForm authorizationForm" method="post">
                        <label for="login"> Логин</label>
                        <input type="text" name="AutoLoggin" placeholder="Логин">

                        <label for="AutoLoggin"> Пороль</label>
                        <input type="text" name="AutoPassword"  placeholder="Пороль">
