            ...
            <div class="main__container">
               <!-- Slider main container -->
                <div class="main_Authorization">
                    <form action="includes/resistered.php" class="registerForm" enctype="multipart/form-data" method="post">
                        ...
                        <input type="text" name="regEmaill" placeholder="Введите emaill-адресс">

                        <label for="password"> Пороль</label>
                        <input type="text" name="regPassword" placeholder="Введите Пороль">

                        <label for="password-accept"> Подтверждение пороля</label>
                        <input type="text" name="regPasswordAccept"placeholder="Введите повторный Пороль">
